...
test testv:
	...
	echo "ENV AWS_SESSION_TOKEN $AWS_SESSION_TOKEN" >> tests/Dockerfile
	echo "ENV AWS_SECRET_ACCESS_KEY $AWS_SECRET_ACCESS_KEY" >> tests/Dockerfile
	echo "ENV AWS_ACCESS_KEY_ID $AWS_ACCESS_KEY_ID" >> tests/Dockerfile
	echo "ENV AWS_REGION us-west-2"
